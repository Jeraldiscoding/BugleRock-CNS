...
const mockDepartments = [
  {
    ...
    personnel: ['Mike Lim', 'Parvathy Srikant', 'Duresh Kumar'],
    leads: '10 New Leads',
    processing: '6 In Processing',
    actionText: '2 Awaiting Action',
    actionLabel: null,
    isAlert: false,
    activeText: '90 Active • $800M',
  },
  {
    id: 'uhnw',
    name: 'UHNW',
    managers: 'Dheeraj Bharwani',
    personnel: ['Mike Lim', 'Subiksha'],
    leads: '8 New Leads',
    processing: '6 In Processing',
    actionText: '3 Awaiting Action',
    actionLabel: 'Bottleneck Detected',
    isAlert: true,
    activeText: '52 Active • $400M',
  },
  {
    id: 'investments',
    name: 'Investments',
    managers: 'Jeremy Sim',
    personnel: ['William', 'Rishav Baid'],
    leads: '4 New Leads',
  ...
  },
  {
    id: 'operations',
    name: 'Operations',
    managers: 'Aditi Gautam',
    personnel: ['Nidhi Khemka', 'Zeel'],
    leads: '0 New Leads',
    processing: '8 In Processing',
    actionText: '4 Awaiting Action',
    actionLabel: null,
    isAlert: false,
    activeText: '12 Active • $500M',
  },
  {
    id: 'compliance',
    name: 'Compliance',
    ...
    personnel: ['Nidhi Khemka', 'Zeel'],
    leads: '0 New Leads',
    processing: '4 In Processing',
    actionText: '4 Awaiting Action',
    actionLabel: 'High Volume',
    isAlert: true,
    activeText: '6 Active • $340M',
  }
];
...
const mockEscalations = [
  {
    ...
    riskText: '⚠️ Missing KYC for Apex Corp. Routed to Stefan Ho (Compliance).',
    baseColor: 'error'
  },
  {
    id: 2,
    ...
    <div className="bg-surface text-on-surface selection:bg-primary-container selection:text-on-primary-container min-h-screen font-body">
      ...
      <aside className="flex flex-col fixed left-0 top-0 z-40 h-screen w-64 border-r border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 font-headline tracking-tight">
        ...
        <nav className="flex-1 px-3 mt-4 space-y-1">
          <a onClick={handleBackToOverview} className={`flex items-center gap-3 px-3 py-2 ${activeView === 'overview' ? 'text-primary dark:text-primary font-semibold border-r-2 border-primary bg-primary/10' : 'text-slate-500 dark:text-slate-400 hover:text-primary/70 hover:bg-primary/5'} cursor-pointer active:scale-95 transition-colors duration-200`}>
          ...
          <a onClick={() => { setActiveView('aum'); setSelectionContext(null); }} className={`flex items-center gap-3 px-3 py-2 ${activeView === 'aum' ? 'text-primary dark:text-primary font-semibold border-r-2 border-primary bg-primary/10' : 'text-slate-500 dark:text-slate-400 hover:text-primary/70 hover:bg-primary/5'} cursor-pointer active:scale-95 transition-colors duration-200`}>
      ...
      <header className="flex items-center justify-between px-8 w-[calc(100%-16rem)] ml-64 fixed top-0 z-30 docked full-width h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none font-headline font-medium text-sm">
        <div className="flex items-center gap-8">
          <div className="flex gap-6">
            <a className="text-slate-900 dark:text-white border-b-2 border-slate-900 dark:border-slate-50 pb-4 translate-y-[8px]" href="#">Global Search</a>
            <a className="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all" href="#">Departments</a>
            <a className="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all" href="#">Clients</a>
          </div>
        </div>
        <div className="flex items-center gap-6">
          <div className="relative group">
            ...
            <input className="pl-10 pr-4 py-1.5 bg-surface-container-low border-none rounded-md text-sm w-64 focus:ring-1 focus:ring-slate-200 transition-all outline-none" placeholder="Search systems..." type="text" />
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right">
                <p className="text-xs font-bold text-slate-900">Managing Partner</p>
                <p className="text-[10px] text-slate-500">BugleRock CNS</p>
              </div>
                ...
                <div className="flex-1 overflow-x-auto pb-4">
                  <div className="flex gap-6 min-w-max h-full">
                    ...
                    <div className="w-72 bg-slate-50/50 dark:bg-slate-900/50 rounded-xl p-4 border border-slate-100 dark:border-slate-800/50 flex flex-col gap-4">
                      ...
                      >
                        <div className="font-bold text-sm text-slate-900 dark:text-slate-100 group-hover:text-primary transition-colors">Bruce Wayne</div>
                        <p className="text-xs text-slate-500 mt-2 line-clamp-2">Module A: Evaluating intent from email...</p>
                      </div>
                    ...
                    <div className="p-6">
                      <div className="bg-white dark:bg-slate-950 p-4 rounded-xl border border-slate-200 dark:border-slate-800/80 shadow-inner relative">
                        ...
                        <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed italic">
                          "Client expressed interest in Q3 Rebalancing; urgent tone detected regarding tech sector volatility."
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-surface-container-lowest p-6 rounded-xl transition-all hover:shadow-sm border border-transparent">
                  ...
                  <h3 className="font-headline text-3xl font-bold text-on-surface">842 <span className="text-sm font-normal text-on-surface-variant">handled</span></h3>
                ...
                <div className="bg-surface-container-lowest p-6 rounded-xl transition-all hover:shadow-sm border border-transparent ring-1 ring-error/10">
                  ...
                  <h3 className="font-headline text-3xl font-bold text-error">3</h3>
                  ...
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-outline-variant/10">
                      {mockDepartments.map((dept) => (
                        <tr key={dept.id} onClick={() => handleViewDepartment(dept)} className="cursor-pointer hover:bg-slate-50 transition-all group">
                          ...
                          <td className="p-5 text-sm text-on-surface-variant">{dept.leads}</td>
                          <td className="p-5 text-sm text-on-surface-variant">{dept.processing}</td>
                          <td className={`p-5 ${dept.isAlert ? 'bg-tertiary-container/10' : ''}`}>
                            <div className="flex items-center gap-2">
                              {dept.isAlert && <div className="w-1.5 h-1.5 rounded-full bg-tertiary"></div>}
                              <span className={`text-sm ${dept.isAlert ? 'font-semibold text-tertiary' : 'text-on-surface-variant'}`}>{dept.actionText}</span>
                            </div>
                            {dept.actionLabel && (
                              <p className="text-[10px] text-tertiary/70 mt-1 uppercase font-bold tracking-tighter">{dept.actionLabel}</p>
                            )}
                          </td>
                          <td className="p-5 text-sm text-on-surface-variant">{dept.activeText}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
